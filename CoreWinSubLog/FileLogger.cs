...
namespace CoreWinSubLog
{
    public abstract class FileLogger
    {
        ...
        public abstract void Log(LogLevel loglevel,DateTime time, string modelName, string msg, params object[] args);

        /// <summary>
        /// Log a debug message to the logger.
        /// </summary>
        ///  <param name="time">Log message create time.</param>
        ///  <param name="modelName">Log message create source process.</param>
        /// <param name="msg">Log message (format string).</param>
        /// <param name="args">Log message arguments.</param>
        public void Debug(DateTime time,string modelName,string msg,params object[] args)
        {
            string formatMsg = NameFormatToPositionalFormat(msg);
            this.Log(LogLevel.Debug,time,modelName,msg);
        }
        ...
        /// <param name="msg">Log message (format string).</param>
        /// <param name="args">Log message arguments.</param>
        public void Info(DateTime time, string msg,string modelName, params object[] args)
        {
            string formatMsg = NameFormatToPositionalFormat(msg);
            this.Log(LogLevel.Info, time, modelName, msg);
        }
        ...
        /// <param name="msg">Log message (format string).</param>
        /// <param name="args">Log message arguments.</param>
        public void Warn(DateTime time, string msg,string modelName, params object[] args)
        {
            string formatMsg = NameFormatToPositionalFormat(msg);
            this.Log(LogLevel.Warning, time, modelName, msg);
        }
        ...
        public void Error(DateTime time, string msg,string modelName, params object[] args)
        {
            string formatMsg = NameFormatToPositionalFormat(msg);
            this.Log(LogLevel.Error, time, modelName, msg);
        }
        ...
        /// <param name="msg">Log message (format string).</param>
        /// <param name="args">Log message arguments.</param>
        public void Fatal(DateTime time, string msg,string modelName, params object[] args)
        {
            string formatMsg = NameFormatToPositionalFormat(msg);
            this.Log(LogLevel.Fatal, time, modelName, msg);
        }
